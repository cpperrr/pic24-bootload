...
namespace WindowsFormsApplication1
{
    public class UserExplainFile
    {
        ...
        public static UserFileData[] flash_Data = new UserFileData[UserConfig.FLASH_DATA_BUF_LENGTH];
        public static int CurSecNum = 0xffffff;
        public static int Flash_SectionNum = 0;
        public static int Flash_FrameNum = 0;
        ...
        {
            for (int i = 0; i < UserConfig.FLASH_DATA_BUF_LENGTH; i++)
            {
                ...
                for (int k = 0; k < UserConfig.FLASH_DATA_BUF_SIZE; k++)
                {
        ...
        public static UserFileData GetSectionData(int Num)
        {
            ...
            if (Num >= UserConfig.FLASH_DATA_BUF_LENGTH)
            {
                return (temp);
            }
        ...
        {
            String temp = null;
            byte[] flashdata = new byte[UserConfig.FLASH_DATA_BUF_SIZE];
            int i = 0;
            int StartNum = 8;
